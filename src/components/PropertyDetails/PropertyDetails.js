...
const PropertyDetails = () => {
    ...
    const { fetchPropertyDetails, selectProperty, propertyRemove } = useContext(PropertyContext);
    const { propertyId } = useParams();

    const currentProperty = selectProperty(propertyId);

    useEffect(() => {
        (async () => {
            const propertyDetails = await propertyService.getOne(propertyId);
            console.log(propertyDetails);


            fetchPropertyDetails(propertyId, { ...propertyDetails });
        })();
    }, [])
            ...
            <div className="content-area single-property" style={{ backgroundColor: "#FCFCFC" }}>
                <div className="container">
                    ...
                    <div className="clearfix padding-top-40">
                        <div className="col-md-8 single-property-content " style={{ width: "100%" }}>
                            <div className="row">
                                <div className="light-slide-item">
                                    <div className="clearfix">
                                        ...
                                        <ul id="image-gallery" className="gallery list-unstyled cS-hidden">
                                            <li data-thumb={currentProperty.image}>
                                                <img src={currentProperty.image} alt="" />
                                            </li>
                            ...
                            <div className="single-property-wrapper">
                                ...
                                <div className="property-meta entry-meta clearfix ">
                                    ...
                                    <div className="col-xs-3 col-sm-3 col-md-3 p-b-15">
                                        ...
                                        <span className="property-info-entry">
                                            ...
                                            <span className="property-info-value">{currentProperty.floor}</span>
                                        </span>
                                    </div>
                                    ...
                                    <div className="col-xs-3 col-sm-3 col-md-3 p-b-15">
                                        ...
                                        <span className="property-info-entry">
                                            ...
                                            <span className="property-info-value">{currentProperty.storey}</span>
                                        </span>
                                    </div>
                                    ...
                                    <div className="col-xs-3 col-sm-3 col-md-3 p-b-15">
                                        ...
                                        <span className="property-info-entry">
                                            <span className="property-info-label">Yard Area <b className="property-info-unit">m2</b></span>
                                            <span className="property-info-value">{currentProperty.yardArea}</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="section additional-details">
                                    ...
                                    <ul className="additional-details-list clearfix">
                                        <li>
                                            ...
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.bedroom}</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Bathroom/s</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.bathroom}</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Storage/s</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.storage}</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Parking</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.parking}</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">Basement</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.basement}</span>
                                        </li>

                                        <li>
                                            <span className="col-xs-6 col-sm-4 col-md-4 add-d-title">View</span>
                                            <span className="col-xs-6 col-sm-8 col-md-8 add-d-entry">{currentProperty.view}</span>
                                        </li>
                                ...
                                <div className="button navbar-right">
                                    {user._id === currentProperty.userId
                                        ? <div id="user">
                                            <Link to={`/property-list/${currentProperty._id}/edit`}>
                                                <button className="navbar-btn nav-button wow bounceInRight login" data-wow-delay="0.45s">Edit</button>
                                            </Link>
                                            <button className="navbar-btn nav-button wow fadeInRight" onClick={propertyDeleteHandler}>Delete</button>
                                        </div>
                                        : null
                                    }
                                </div>
